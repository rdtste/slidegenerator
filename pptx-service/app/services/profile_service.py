"""Deep template profiling service — extracts comprehensive visual DNA from PowerPoint templates.

This service goes far beyond basic layout classification. It extracts:
...
def _build_chart_guidelines(profile: TemplateProfile) -> None:
    ...
    profile.chart_guidelines = ChartGuidelines(
        ...
        grid_color=_lighten_color(dna.text, 0.8),
        text_color=dna.text,
        style="modern_flat",
